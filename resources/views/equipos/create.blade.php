...
@section('content')
    <div class="container mt-4">
        ...
        <form action="{{ route('equipos.store') }}" method="POST">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="tipo" id="tipo" class="form-select" required>
                            ...
                            <option value="monitor">Monitor/Impresora/Estabilizador/Proyector/Switch/Rack</option>
            ...
            <div class="card mb-4" id="componentes-card" style="display: none;">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Disco Duro/Disco Sólido</label>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="ubicacion_text" class="form-control" placeholder="Escribe ubicación"
                            required>
    ...
    <script>
        function toggleComponentes() {
            ...
            if (tipo === 'cpu') {
                ...
                componentesCard.style.display = "none";
                componentesCard.querySelectorAll("input, select, textarea").forEach(el => el.value = "");
            }
        }

        document.addEventListener("DOMContentLoaded", function () {
            toggleComponentes();
            document.getElementById('tipo').addEventListener('change', toggleComponentes);
        });
