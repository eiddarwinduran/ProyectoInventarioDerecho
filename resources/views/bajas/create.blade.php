...
@section('content')
    <div class="container mt-4">
        ...
        <form action="{{ route('bajas.store') }}" method="POST">
            ...
            <div class="mb-3">
                <label for="responsable" class="form-label">Responsable Actual</label>
                <input type="text" id="responsable" class="form-control" readonly>
        ...
        $(document).ready(function () {
            ...
            $("#codigo_text").autocomplete({
                ...
                select: function (event, ui) {
                    ...
                    $.get("{{ route('bajas.getResponsable') }}", { codigo: ui.item.value }, function (data) {
                        $("#responsable").val(data.nombre + " (" + data.ci + ")");
                        $("#ci").val(data.ci);
                    });
